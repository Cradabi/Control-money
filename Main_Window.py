...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clear_sortbutton = QtWidgets.QPushButton(self.centralwidget)
        self.clear_sortbutton.setGeometry(QtCore.QRect(115, 451, 181, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.addButton.sizePolicy().hasHeightForWidth())
        self.clear_sortbutton.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.clear_sortbutton.setFont(font)
        self.clear_sortbutton.setMouseTracking(False)
        self.clear_sortbutton.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.clear_sortbutton.setObjectName("clear_sortbutton")
        ...
        self.textEdit.setGeometry(QtCore.QRect(150, 125, 131, 25))
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(470, 125, 131, 25))
