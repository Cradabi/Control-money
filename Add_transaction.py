...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox1.setItemText(4, _translate("Dialog", "Подарки"))
        self.comboBox1.setItemText(5, _translate("Dialog", "Образование"))
        self.comboBox1.setItemText(6, _translate("Dialog", "Электроника"))
        self.comboBox1.setItemText(7, _translate("Dialog", "Развлечения"))
        self.comboBox1.setItemText(8, _translate("Dialog", "Подписки"))
        self.comboBox1.setItemText(9, _translate("Dialog", "Прочее"))
